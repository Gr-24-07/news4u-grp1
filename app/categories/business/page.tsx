...
import { ArticleCardLatestNews, ArticleCardPopularNews, ArticleCardEditorChoice, AllLatestNews } from '@/app/front-page/ArticleCard';
  ...
  return (
    <main className="w-full px-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-10 p-5">            
        {/* Latest News Section */}
        <section className="order-1 md:order-2 lg:order-2 col-span-1 md:col-span-2 lg:col-span-2 ">                <h2 className="text-sm font-bold mb-6 text-red-500 hover:text-red-900">Latest News</h2>
