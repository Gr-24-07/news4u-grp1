  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center py-2">
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
        ...
        <p className="mb-4 font-bold underline">Please check your email to verify your account.</p>
        <p className="mb-2">Once verified, you'll be able to sign in and access all features.</p>
